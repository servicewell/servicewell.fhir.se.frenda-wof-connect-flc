...
* structure[+].url = Canonical(get-schedule)
* structure[=].mode = #source
* structure[+].url = Canonical(ITBSchedule)
...
* group.rule.target.extension[FhirLiquidMap].extension[flcPackage].valueString = "servicewell.se.fhir.frenda-wof-flc"
